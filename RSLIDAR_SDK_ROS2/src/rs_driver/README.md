> **Documentation note:** omitted upstream media links target the pinned upstream snapshot.
...
For more info about `demo_online`, Please refer to [Decode online LiDAR](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/08_how_to_decode_online_lidar.md)

For more info about `demo_pcap`, Please refer to [Decode pcap file](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/10_how_to_decode_pcap_file.md)
...
For more info about `rs_driver_viewer`, please refer to [Visualization tool guide](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/14_how_to_use_rs_driver_viewer.md)
...
+ What is available in the **rs_driver** project? Include examples, tools, documents.
    ...
    Please see[Directories and Files](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/intro/02_directories_and_files.md)
...
+ There are two versions of **rs_driver**: `v1.3.x` and `v1.5.x`. Which is suggested? Is it suggested to upgrade to `v1.5.x` ? How to upgrade?
    ...
    Please see[How to port from v1.3.x to v1.5.x](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/07_how_to_port_your_app_from_rs_driver_1.3.x_to_1.5.x.md)

+ How to compile **rs_driver** on Windows ?

    Please see[How to compile `rs_driver` on Windows](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/16_how_to_compile_on_windows.md)

+ What is the interface of **rs_driver** like ? How to integrate it into my system?

    Please see[Thread Model and Interface](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/intro/03_thread_model.md)

+ Is there any examples about how to integrate **rs_driver** ? And if mulitple LiDARs?

    Please see[How to connect to online LiDAR](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/08_how_to_decode_online_lidar.md)，[How to decode PCAP file](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/10_how_to_decode_pcap_file.md)。
...
+ How to configure **rs_driver**'s network options in unicast/multicast/broadcast mode? And if mulitple Lidars? With VLAN layer? May I add extra layers before/after MSOP/DIFOP packet? All configurations are OK, and Wireshark/tcpdump can capture the packets, but **rs_driver** still fails to get them. Why ?
    ...
    Please see[Online LiDAR - Advanced Topics](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/09_online_lidar_advanced_topics.md)
...
+ To decode a PCAP file with only one LiDAR data, how to configure `rs_driver`? And if multiple LiDARs? With VLAN layer? With extra layers before/after MSOP/DIFOP packet?
    ...
    Please see[PCAP File - Advanced Topics](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/11_pcap_file_advanced_topics.md)

+ Can I determine how to configure `rs_driver` by a PCAP file? For both online LiDAR and PCAP file?

    Please see[How to configure rs_driver by PCAP file](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/12_how_to_configure_by_pcap_file.md)

+ What format of PCAP file is supported by `rs_driver`? How to capture such a file?

    Please see[How to capture a PCAP file for rs_driver](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/13_how_to_capture_pcap_file.md)
...
+ How to compile demo apps/tools? How to avoid packet loss? How much is CPU usage? Point cloud is UTC time. How to convert it to loca time? How to disable PCAP file decoding on embedded Linux? How to enable point transformation?
    ...
    Please see[rs_driver CMake Macros](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/intro/05_cmake_macros_intro.md)
...
+ How to specify Lidar type? How to specify data source (online LiDAR, PCAP file, user's data) ? How to timestamp point cloud with LiDAR clock or Host clock? How to discard NAN points in point cloud? Where does point cloud get its timestamp? from its first point, or last point? How to configure point transform? How to change the splitting angle of mechanical LiDAR?
    ...
    Please see[rs_driver configuration parameters](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/intro/04_parameter_intro.md)

+ **rs_driver** reports an error `ERRCODE_MSOPTIMEOUT`/`ERRCODE_WRONGMSOPID`/`ERRCODE_PKTBUFOVERFLOW` ...... What does it mean?

    Please see[rs_driver Error Code](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/intro/06_error_code_intro.md)

+ How to transform point cloud to another position?

    Please see[How to transform point cloud](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/15_how_to_transform_pointcloud.md)

+ How much is data flow of RoboSense LiDARs ? When may it loss packets? How to avoid this?

    Please see[How to avoid packet Loss](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/17_how_to_avoid_packet_loss.md)

+ How much CPU and memory does **rs_driver** need？

    Please see[CPU Usage and Memory Usage of `rs_driver`](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/20_about_usage_of_cpu_and_memory.md)

+ What is point layout like? What's the coordinate system of **rs_driver**? What is `ring` of point? Where is point timestamp from?

    Please see[Point Layout in point cloud](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/18_about_point_layout.md)

+ How does RoboSense split frames? It uses the UDP protocol. What if packet loss or out of order?

    Please see[Splitting frames](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/howto/19_about_splitting_frame.md)

+ Want to know more implementation details about `rs_driver`?

    Please see[Analysis of rs_driver&#39;s source code](https://raw.githubusercontent.com/RoboSense-LiDAR/rs_driver/897b14d3bdb6186a75df27ba51b65b5bd5557723/doc/src_intro/rs_driver_intro_CN.md)
